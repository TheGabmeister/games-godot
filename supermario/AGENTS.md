...
- Level terrain uses procedural TileSets generated by
  `scripts/level/tileset_builder.gd`; `level_base.gd` and `level_1_2.gd` keep
  matching `TILE_SIZE` constants for camera limits and scene construction.
